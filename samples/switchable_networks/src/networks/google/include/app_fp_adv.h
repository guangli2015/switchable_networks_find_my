...
/** Fast Pair advertising callbacks. */
struct app_fp_adv_cb {
	/** Notify the user that the Fast Pair advertising state has changed.
	 *
	 * @param enabled If true, the Fast Pair advertising is enabled. Otherwise, it is disabled.
	 */
